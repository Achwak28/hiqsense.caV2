    ...
    return (
        <>
            <section className="px-4 lg:px-40 pb-20">
                <div className="grid grid-cols-1 lg:grid-cols-2"><div><h2 className="font-hebrew-bold text-[32px] text-center text-txt-primary mb-6">Get in <span className="text-btn-primary">Touch</span></h2>
                    ...
                    <div><img src={mapImg} alt="mapImg" className='hidden lg:block lg:mx-auto'/></div>
                    </div>
