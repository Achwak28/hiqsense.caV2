                ...
                <div className="bg-[#4334B6] h-[620px] w-100 flex flex-col justify-center items-center content-center flex-wrap px-2 relative z-[2]">
                    <div className="largeElipseBlock">
                        ...
                        <div className="mediumElipseBlock">
                            <img src={mediumElipse} alt="mediumElipse" className="dropShadow" />
                            <div className="smallElipseBlock">
                                <img src={smallElispe} alt="smallElispe" className="dropShadow" />
                    ...
                    <HeroContent firstWord="Crafting" headingText=" Digital Experiences That Inspire and Engage" subHeading="Innovative Web and Graphic Design Solutions Tailored for Your Brand" />
                </div>
            </section>
        </>
    );
