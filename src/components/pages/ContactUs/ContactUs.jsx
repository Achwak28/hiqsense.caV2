...
const ContactUs = () => {
    ...
    return (
        <main className='pt-14 bg-[#F9F9F9] flex-1 min-h-[100dvh] w-full flex flex-col'>
            ...
            >
                <motion.div className=" min-h-[317px] flex flex-col items-center w-full max-w-[1200px] mx-auto " variants={cardVariants}>
                    <div className='w-full max-w-[755px] flex flex-col items-center gap-10 pt-4 pb-24 px-2 sm:px-6 text-white' >
                        <h1 className='text-3xl sm:text-4xl md:text-5xl text-left font-bold '> Do You Have a Question? </h1>
                        <p className='text-base font-medium'> You may go to our
                            <span className='text-[#F6393D] font-bold px-1'>
                                FAQ
                            </span>
                            page and look for the answers to your inquiries or you may send us an email.
                        </p>
                        <Link to='/faq' className='w-[137px] flex items-center justify-center rounded h-12 bg-[#F6393D] text-base font-bold mt-5'>
                            View FAQ
                        </Link>
