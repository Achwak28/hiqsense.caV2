...
const Header = () => (
  <Box  > 
  <header style={{backgroundColor:"#4334B6", position:"fixed" , zIndex:"99"}} className="z-[100] flex relative flex-row gap-5 justify-between self-center px-20 w-full text-sm bg-indigo-700 border-b border-solid 
