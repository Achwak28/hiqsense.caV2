...
function TimelineSteps({ stepsContent }) {
  ...
  return (
    <>
      <div
        className={`w-[100%] h-[224px] lg:h-[330px] bg-transparent relative md:z-10 rightLine ${lowerCol}`}
        data-aos="fade-right"
      ...
      >
        <img
          src={rightImg}
          alt="rightImage"
          className="absolute top-0 left-0 lg:w-full"
        />
        <h4 className="text-center text-[#FFFFFF] font-hebrew-bold text-[18px] mb-3 lg:text-[20px]">
          {Steps}
        </h4>
        <div>
          <h3 className="text-left text-[#FFFFFF] font-hebrew-bold text-[24px] mb-2 lg:text-[32px]">
            {Heading}
          </h3>
          <p className="text-left text-[#FFFFFF] font-hebrew-regular text-[14px] lg:text-[18px]">
            {SubHeading}
          </p>
        </div>
      </div>
