...
const Footer = () => {
  ...
  return (
    <Stack direction={"column"}>
      <BuildingBusiness />
      <Box>
        <footer className="footer-content-bottom flex flex-col items-center px-32 w-full bg-[#31135E] py-5 max-md:px-5  max-md:max-w-full">
          <div className="flex z-10 flex-col mt-0 w-full max-w-[1188px] max-md:max-w-full">
            <Box>
              <header className="flex footer-header-content gap-5 justify-between items-center mt-24 text-2xl font-bold text-white max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
                <Link to="/">
                  <img
                    loading="lazy"
                    src={logo}
                    alt="Brand logo"
                    className="my-auto max-w-full aspect-[7.69] w-full md:w-[380px] h-[51px]"
                  />
                </Link>
            ...
            <nav className="flex flex-col gap-5 justify-start items-center md:items-start  my-8 w-full max-md:flex-wrap  max-md:max-w-full">
              <div className="w-full sm:w-fit md:w-fit sm:gap-8 md:gap-14 flex md:items-start items-center justify-start sm:justify-normal mb-5 sm:mb-10 text-white whitespace-nowrap ">
