...
const OfferingSection = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      <h3
        id="servicesStart"
        className="text-center font-bold text-lg pt-2 pb-2 sm:text-xl sm:pt-4 sm:pb-4 md:text-3xl md:pt-6 md:pb-6 lg:text-4xl lg:pt-8 lg:pb-8 xl:text-custom-large 
      xl:pt-16 xl:pb-16 text-custom-color font-ebgaramond"
      >
        What We Offer
      </h3>
